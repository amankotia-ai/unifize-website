"""
storyboard.py - a captioned storyboard sheet for one of the homepage hero
films: the scene's board frames (window on the hero wash, grain on) in
beat order, each with its time, what happens and what lands.

  node ../../platform-render/v3/frames.mjs film.html OUT board <times> --vp=1496x768 --dsf=1 --query=step=N
  python3 storyboard.py OUT beats/sN.json SHEET.jpg
