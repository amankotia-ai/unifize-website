...
export const CONTENT_BLOCKS = {
  ...
  sections: {
    "DMS-S01": {
      "Headline line 1": "dms/hero.line1",
      "Headline line 2": "dms/hero.line2",
      Subhead: "dms/hero.sub",
      "CTA primary": "dms/hero.cta1",
      "CTA secondary": "dms/hero.cta2",
    },
    "DMS-S02": { Label: "dms/trust.label" },
    "DMS-S03": { Subhead: "dms/problem.heading", Lede: "dms/problem.lede" },
    "DMS-S04": { Heading: "dms/ctax.heading", Lede: "dms/ctax.lede" },
    "DMS-S05": { Heading: "dms/modules.heading", Subhead: "dms/modules.lede" },
    "DMS-S06": { Heading: "dms/capabilities.heading" },
    "DMS-S07": { Heading: "dms/lifecycle.heading" },
    "DMS-S08": {
      Heading: "dms/integrations.heading",
      Subhead: "dms/integrations.lede",
      "CTA heading": "dms/integrations.cta.heading",
      "CTA body": "dms/integrations.cta.body",
      "CTA label": "dms/integrations.cta.label",
    },
    "DMS-S09": { Heading: "dms/audience.heading", Subhead: "dms/audience.lede" },
    "DMS-S10": { Heading: "dms/proof.heading", Subhead: "dms/proof.sub" },
    "DMS-S11": { Heading: "dms/compliance.heading", Subhead: "dms/compliance.lede" },
    "DMS-S12": { Heading: "dms/faq.heading" },
    "DMS-S13": {
      Heading: "dms/close.eyebrow",
      Subhead: "dms/close.heading",
      Body: "dms/close.lede",
      CTA: "dms/close.cta",
    },
