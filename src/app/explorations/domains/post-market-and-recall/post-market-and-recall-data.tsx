...
export const POST_MARKET_DATA: DomainPageData = {
    ...
    groups: [
      {
        ...
        runsIn: { label: "Complaints run in the QMS →", href: "/products/qms" },
        items: [
      ...
      },
      {
        ...
        runsIn: { label: "Reportability runs in the QMS →", href: "/products/qms" },
        items: [
  ...
  industries: {
    ...
    rows: [
      { name: "Medical devices", line: "Complaints, MDR reporting and field corrections.", chips: ["21 CFR 803", "21 CFR 806", "EU MDR"], href: "/industries/medical-devices" },
      { name: "Pharmaceuticals", line: "Product complaints, adverse events and market withdrawal.", chips: ["21 CFR 7", "21 CFR 211"], href: "/industries/pharmaceuticals" },
      { name: "Food processing", line: "Holds, traceability to the affected lot and public notice.", chips: ["FSMA", "21 CFR 7"], href: "/industries/food-processing" },
      { name: "Cosmetics", line: "Adverse event records and batch-level traceability.", chips: ["MoCRA"], href: "/industries/cosmetics" },
      { name: "Nutritional supplements", line: "Serious adverse event reports and complaint files.", chips: ["21 CFR 111"], href: "/industries/nutritional-supplements" },
      { name: "Automotive", line: "Field campaigns, warranty claims and 8D back to the supplier.", chips: ["IATF 16949"], href: "/industries/automotive" },
      { name: "Aerospace", line: "Field escapes, service bulletins and returned-material investigation.", chips: ["AS9100"], href: "/industries/aerospace" },
      { name: "Chemicals", line: "Customer complaints, lot traceability and product withdrawal.", chips: ["ISO 9001"], href: "/industries/chemicals" },
      { name: "Industrial machinery", line: "Field service, warranty and safety notices to the installed base.", chips: ["ISO 9001"], href: "/industries/industrial-machinery" },
    ],
    ...
    groups: [
      {
        ...
        modules: [
          { name: "Complaint Handling", blurb: "Intake, triage, investigation and closure of customer complaints, with complainant detail, product or batch reference and the regulatory reportability assessment held on the record.", standards: ["ISO 13485", "21 CFR 820", "EU MDR"], href: "/products/qms" },
          { name: "Corrective & Preventive Actions", blurb: "Root-cause acceptance, action plan, effectiveness verification and closure, related back to the complaint or field event that raised it.", standards: ["ISO 13485", "21 CFR 820"], href: "/products/qms" },
        ],
      },
      {
        slug: "mes",
        ...
        modules: [
          { name: "Electronic Batch/Lot Records with QR Codes", blurb: "Electronic batch and lot records with QR code generation, so traceability runs through manufacturing and out into distribution.", standards: ["21 CFR 11", "21 CFR 211", "EU GMP"], href: "/products/mes" },
        ],
      },
      {
        slug: "field-action",
    ...
    references: [
      {
        ...
        link: { label: "Complaints run in the QMS →", href: "/products/qms" },
      },
