...
export const SUPPLIER_MANAGEMENT_DATA: DomainPageData = {
    ...
    groups: [
      {
        ...
        runsIn: { label: "Runs in the QMS product →", href: "/products/qms" },
        items: [
      ...
      },
      {
        ...
        runsIn: { label: "Specifications run in the DMS →", href: "/products/dms" },
        items: [
  ...
  industries: {
    ...
    rows: [
      { name: "Medical devices", line: "Purchasing controls, supplier qualification and incoming acceptance.", chips: ["21 CFR 820", "ISO 13485"], href: "/industries/medical-devices" },
      { name: "Pharmaceuticals", line: "Vendor management and quality agreements.", chips: ["21 CFR 210/211", "EU GMP", "ICH Q10"], href: "/industries/pharmaceuticals" },
      { name: "Automotive", line: "Supplier quality engineering, PPAP and supplier corrective action.", chips: ["IATF 16949", "PPAP", "APQP"], href: "/industries/automotive" },
      { name: "Aerospace", line: "Supplier approval, first article inspection and requirement flow-down.", chips: ["AS9100", "FAI · AS9102", "NADCAP"], href: "/industries/aerospace" },
      { name: "Chemicals", line: "Supplier qualification and approved vendor list management.", chips: ["ISO 9001", "ICH Q7", "REACH"], href: "/industries/chemicals" },
      { name: "Food processing", line: "Approved supplier list and material approval.", chips: ["FSMA · 21 CFR 117", "SQF", "BRCGS"], href: "/industries/food-processing" },
      { name: "Laboratories", line: "Reagent and consumable supplier approval, certificate control.", chips: ["ISO/IEC 17025", "GLP · 21 CFR 58"], href: "/industries/laboratories" },
      { name: "Cosmetics", line: "Ingredient supplier approval and certificate verification.", chips: ["MoCRA", "ISO 22716"], href: "/industries/cosmetics" },
      { name: "Nutritional supplements", line: "Ingredient identity, supplier qualification and incoming testing.", chips: ["21 CFR Part 111", "cGMP"], href: "/industries/nutritional-supplements" },
      { name: "Industrial machinery", line: "Build-to-order supplier approval and first article on long-lead parts.", chips: ["ISO 9001", "FAT / SAT"], href: "/industries/industrial-machinery" },
      { name: "Contract research orgs", line: "Vendor oversight and qualification of service providers.", chips: ["ICH E6(R2) GCP"], href: "/industries/cro" },
    ],
    ...
    groups: [
      {
        ...
        modules: [
          { name: "Supplier Quality", blurb: "Supplier corrective action lifecycle, supplier qualification, incoming inspection alignment and scorecard maintenance.", standards: ["ISO 13485", "IATF 16949", "AS 9100", "EU GMP"], href: "/products/qms" },
          { name: "Corrective & Preventive Actions", blurb: "Root-cause acceptance, action plan, effectiveness verification and closure, related back to the originating non-conformance so the supplier trace is end to end.", href: "/products/qms" },
        ],
      },
      {
        slug: "dms",
        ...
        modules: [
          { name: "Change Control", blurb: "Change requests, change orders and document revisions on configurable approval workflows, with impact assessment and downstream propagation to training and distribution.", standards: ["ISO 9001", "ISO 13485", "21 CFR 820", "ICH Q10"], href: "/products/dms" },
        ],
      },
      {
        slug: "mes",
        ...
        modules: [
          { name: "Inspections, Forms & Checklists", blurb: "Configurable inspection forms and checklists executed at defined points in the workflow, including receiving.", standards: ["ISO 9001", "21 CFR 820"], href: "/products/mes" },
          { name: "Electronic Batch/Lot Records", blurb: "Electronic batch and lot records with QR code generation, carrying traceability through manufacturing and distribution.", standards: ["21 CFR Part 11", "21 CFR 211", "EU GMP"], href: "/products/mes" },
        ],
      },
      {
        slug: "apqp-ppap",
