...
export const QUALITY_DATA: DomainPageData = {
  ...
  industries: {
    ...
    rows: [
      { name: "Medical devices", line: "CAPA, complaints and MDR reporting.", chips: ["21 CFR 820", "ISO 13485", "EU MDR"], href: "/industries/medical-devices" },
      { name: "Pharmaceuticals", line: "Deviations, OOS investigations and batch release.", chips: ["21 CFR 211", "ICH Q10"], href: "/industries/pharmaceuticals" },
      { name: "Automotive", line: "NCRs, 8D and supplier quality.", chips: ["IATF 16949"], href: "/industries/automotive" },
      { name: "Aerospace", line: "Nonconformance, MRB and first-article inspection.", chips: ["AS9100", "NADCAP"], href: "/industries/aerospace" },
      { name: "Chemicals", line: "Batch deviations, CoA control and supplier quality.", chips: ["ISO 9001"], href: "/industries/chemicals" },
      { name: "Food processing", line: "Holds, HACCP verification and supplier approval.", chips: ["FSMA", "GFSI"], href: "/industries/food-processing" },
      { name: "Laboratories", line: "OOS handling, calibration and result integrity.", chips: ["ISO/IEC 17025"], href: "/industries/laboratories" },
      { name: "Cosmetics", line: "Complaints, adverse events and batch traceability.", chips: ["MoCRA"], href: "/industries/cosmetics" },
      { name: "Nutritional supplements", line: "Specifications, batch records and complaint files.", chips: ["21 CFR 111"], href: "/industries/nutritional-supplements" },
      { name: "Industrial machinery", line: "NCRs and FAI on build-to-order programs.", chips: ["ISO 9001"], href: "/industries/industrial-machinery" },
      { name: "Contract research orgs", line: "GCP quality events, audit findings and CAPA.", chips: ["ICH E6"], href: "/industries/cro" },
    ],
    ...
    groups: [
      {
        ...
        modules: [
          { name: "Non-conformance", blurb: "Capture, disposition and closure with required fields, named ownership and evidence binding. Escalates into CAPA when warranted.", standards: ["ISO 9001", "ISO 13485", "21 CFR 820", "IATF 16949", "AS 9100"], href: "/products/qms" },
          { name: "Corrective & Preventive Actions", blurb: "Root-cause acceptance, action plan, effectiveness verification and closure, related back to the originating event.", standards: ["ISO 9001", "ISO 13485", "21 CFR 820", "21 CFR 211"], href: "/products/qms" },
          { name: "Quality Events", blurb: "Non-conformances, defects and observations dispositioned with reopen governance.", standards: ["ISO 9001", "21 CFR 820"], href: "/products/qms" },
          { name: "Audit Management", blurb: "Scheduling, finding tracking, response routing and effectiveness verification across internal, external and customer audits.", standards: ["ISO 9001", "ISO 13485", "IATF 16949", "AS 9100"], href: "/products/qms" },
          { name: "Quality Risk Management", blurb: "Risk register, assessment workflows, control verification and periodic review, aligned to ISO 14971 and ICH Q9.", standards: ["ISO 13485", "21 CFR 820"], href: "/products/qms" },
        ],
      },
      {
        slug: "lims",
  ...
  growth: {
    ...
    steps: [
      ...
      { name: "Change control", note: "Live · the PLM product", href: "/products/plm" },
