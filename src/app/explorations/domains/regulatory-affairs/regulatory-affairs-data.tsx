...
export const REGULATORY_AFFAIRS_DATA: DomainPageData = {
  ...
  work: {
    ...
    groups: [
      ...
      },
      {
        ...
        runsIn: { label: "Complaint intake runs in the QMS →", href: "/products/qms" },
        items: [
      ...
      },
      {
        ...
        runsIn: { label: "Lot records run in the MES product →", href: "/products/mes" },
        items: [
      ...
      },
      {
        ...
        runsIn: { label: "Change control runs in the DMS →", href: "/products/dms" },
        items: [
  ...
  industries: {
    ...
    rows: [
      { name: "Medical devices", line: "MDR reporting, 510(k) and PMA files, EU technical documentation.", chips: ["21 CFR 803", "EU MDR", "ISO 13485"], href: "/industries/medical-devices" },
      { name: "Pharmaceuticals", line: "Variations, annual reports and multi-market label control.", chips: ["21 CFR 211", "ICH Q10", "EU GMP"], href: "/industries/pharmaceuticals" },
      { name: "Cosmetics", line: "Product listings, adverse event reports and claims substantiation.", chips: ["MoCRA"], href: "/industries/cosmetics" },
      { name: "Nutritional supplements", line: "Label claims, specifications and serious adverse event reports.", chips: ["21 CFR 111"], href: "/industries/nutritional-supplements" },
      { name: "Food processing", line: "Facility registration, label declarations and reportable food events.", chips: ["FSMA"], href: "/industries/food-processing" },
      { name: "Chemicals", line: "Substance registration, safety data sheets and export licensing.", chips: ["REACH"], href: "/industries/chemicals" },
      { name: "Laboratories", line: "Accredited scope changes, method validation and regulated reporting.", chips: ["ISO 17025"], href: "/industries/laboratories" },
      { name: "Contract research orgs", line: "Sponsor commitments, GCP inspections and study submissions.", chips: ["ICH E6"], href: "/industries/cro" },
    ],
    ...
    groups: [
      {
        ...
        modules: [
          { name: "Complaint Handling", blurb: "Intake, triage, investigation and closure, carrying the regulatory reportability assessment and the link into downstream investigation.", standards: ["ISO 13485", "21 CFR 820", "EU MDR"], href: "/products/qms" },
          { name: "Audit Management", blurb: "Scheduling, finding tracking, response routing and effectiveness verification across internal, external and authority audits.", standards: ["ISO 9001", "ISO 13485", "MDSAP"], href: "/products/qms" },
          { name: "Corrective & Preventive Actions", blurb: "Root-cause acceptance, action plan, effectiveness verification and closure, related back to the event that raised it.", href: "/products/qms" },
        ],
      },
      {
        slug: "dms",
        ...
        modules: [
          { name: "Document Control", blurb: "Controlled authoring, review, approval, distribution and periodic review, with version history, training linkage on revision and effective-date governance.", standards: ["ISO 9001", "ISO 13485", "21 CFR 820", "21 CFR Part 11", "EU GMP"], href: "/products/dms" },
          { name: "Change Control", blurb: "Change requests and document revisions through configurable approvals, carrying impact assessment, evidence and propagation into training and distribution.", standards: ["ISO 9001", "ISO 13485", "21 CFR 820", "ICH Q10"], href: "/products/dms" },
          { name: "Training Management", blurb: "Competency assignment and completion tracking, with retraining triggered by a document revision or an audit finding.", standards: ["ISO 9001", "ISO 13485", "21 CFR 820"], href: "/products/dms" },
        ],
      },
      {
        slug: "ehs",
