...
export const COMPLIANCE_DATA: DomainPageData = {
  ...
  work: {
    ...
    groups: [
      ...
      },
      {
        ...
        runsIn: { label: "Audits run in the QMS product →", href: "/products/qms" },
        items: [
          {
      ...
      },
      {
        ...
        runsIn: { label: "Batch records run in the MES product →", href: "/products/mes" },
        items: [
          {
  ...
  industries: {
    ...
    rows: [
      { name: "Pharmaceuticals", line: "Computer system validation, data integrity and batch record review.", chips: ["21 CFR Part 11", "EU GMP Annex 11", "ICH Q10"], href: "/industries/pharmaceuticals" },
      { name: "Medical devices", line: "Process validation, complaint reportability and inspection response.", chips: ["21 CFR 820", "ISO 13485", "MDSAP"], href: "/industries/medical-devices" },
      { name: "Chemicals", line: "Process safety management, permits and hazardous waste manifests.", chips: ["OSHA PSM", "REACH", "ISO 14001"], href: "/industries/chemicals" },
      { name: "Laboratories", line: "Data integrity, instrument qualification and result traceability.", chips: ["ISO/IEC 17025", "21 CFR Part 11", "ALCOA+"], href: "/industries/laboratories" },
      { name: "Contract research orgs", line: "Trial master file integrity, access control and inspection readiness.", chips: ["ICH E6(R2) GCP", "21 CFR Part 11", "ALCOA+"], href: "/industries/cro" },
      { name: "Food processing", line: "Preventive-control verification, environmental monitoring and permits.", chips: ["FSMA · 21 CFR 117", "HACCP"], href: "/industries/food-processing" },
      { name: "Cosmetics", line: "Adverse event reporting, GMP evidence and label substantiation.", chips: ["MoCRA", "ISO 22716"], href: "/industries/cosmetics" },
      { name: "Nutritional supplements", line: "Specification files, batch records and cGMP evidence on demand.", chips: ["21 CFR Part 111", "cGMP"], href: "/industries/nutritional-supplements" },
      { name: "Aerospace", line: "Special-process approvals, audit findings and export control.", chips: ["AS9100", "NADCAP"], href: "/industries/aerospace" },
      { name: "Automotive", line: "Process validation evidence and audit findings across the supply base.", chips: ["IATF 16949", "PPAP"], href: "/industries/automotive" },
      { name: "Industrial machinery", line: "Commissioning qualification and conformity evidence at customer sites.", chips: ["CE marking", "IQ / OQ / PQ"], href: "/industries/industrial-machinery" },
    ],
    ...
    groups: [
      {
        ...
        modules: [
          { name: "Document Control", blurb: "Controlled authoring, review, approval, distribution and periodic review, with version history, training linkage on revision and effective-date governance.", standards: ["ISO 9001", "21 CFR Part 11", "ISO 13485", "21 CFR 820", "EU GMP"], href: "/products/dms" },
          { name: "Change Control", blurb: "Change requests and document revisions routed through approval, with impact assessment, evidence and downstream propagation to training and distribution.", standards: ["ISO 9001", "21 CFR 820", "ICH Q10", "ISO 13485"], href: "/products/dms" },
          { name: "Training Management", blurb: "Competency assignment and completion tracking, with retraining triggered by a document revision or an audit finding.", standards: ["ISO 9001", "21 CFR 820", "ISO 13485"], href: "/products/dms" },
        ],
      },
      {
        slug: "qms",
        ...
        modules: [
          { name: "Audit Management", blurb: "Scheduling, finding tracking, response routing and effectiveness verification across internal, external and customer audits, with bounded access for outside participants.", standards: ["ISO 9001", "ISO 13485", "MDSAP"], href: "/products/qms" },
          { name: "Corrective Actions", blurb: "Root-cause acceptance, action plan, effectiveness verification and closure, related back to the event that raised it.", standards: ["ISO 13485", "21 CFR 820", "ICH Q10"], href: "/products/qms" },
        ],
      },
      {
        slug: "ehs",
    ...
    references: [
      {
        ...
        link: { label: "Document control & training run in the DMS product →", href: "/products/dms" },
      },
