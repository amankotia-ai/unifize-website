...
export const QMS_PROBLEMS: DmsCoordinationProblem[] = [
  {
    ...
    metric: "Nobody",
    metricLabel: "Owns the finding, so no clock runs on it",
  ...
  },
  {
    ...
    metric: "Weeks",
    metricLabel: "Of slip past the verification target",
  ...
  },
  {
    ...
    metric: "Repeat",
    metricLabel: "Failures of the same defect, delivery after delivery",
