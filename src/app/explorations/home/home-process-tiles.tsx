...
const ROWS: Tile[][] = [
  [
    {
      key: "nonconformance", label: "Non-conformances", href: "/explorations/domains/quality",
    ...
    {
      key: "capa", label: "CAPA", href: "/explorations/domains/quality",
    ...
    {
      key: "audits", label: "Audits", href: "/explorations/domains/compliance",
    ...
    {
      key: "change-control", label: "Change control", href: "/explorations/domains/change-control",
    ...
    {
      key: "document-control", label: "Document control", href: "/explorations/products/dms",
      glyph: (<svg viewBox="0 0 24 24" {...S}><path d="M6 2.5h8L19 7.5v14H6z" /><path d="M14 2.5v5h5" /><path d="M9 12.5h6M9 16h6" /></svg>),
    },
    {
      key: "training", label: "Training", href: "/explorations/products/dms",
    ...
    {
      key: "complaints", label: "Complaints", href: "/explorations/domains/post-market-and-recall",
    ...
    {
      key: "scar", label: "Supplier corrective actions", href: "/explorations/domains/supplier-management",
    ...
    {
      key: "incoming-inspection", label: "Incoming inspection", href: "/explorations/domains/supplier-management",
    ...
    {
      key: "risk", label: "Risk management", href: "/explorations/products/qms",
      glyph: (<svg viewBox="0 0 24 24" {...S}><path d="M12 3.5 21.5 20h-19L12 3.5Z" /><path d="M12 10v4" /><path d="M12 17h.01" strokeWidth={2.6} /></svg>),
    },
    {
      key: "deviations", label: "Deviations", href: "/explorations/domains/quality",
  ...
  [
    {
      key: "periodic-review", label: "Periodic review", href: "/explorations/products/dms",
    ...
    {
      key: "batch-records", label: "Batch records", href: "/explorations/products/mes",
    ...
    {
      key: "work-orders", label: "Work orders", href: "/explorations/products/mes",
    ...
    {
      key: "fai", label: "First article inspection", href: "/explorations/products/mes",
    ...
    {
      key: "control-plans", label: "Control plans", href: "/explorations/products/plm",
