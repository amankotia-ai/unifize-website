...
const DARK_SURFACES = ["itm-hero", "itm-section--dark", "itm-ingress", "itm-close", "itm-footer"];
...
export function SiteHeader() {
  ...
  useEffect(() => {
    ...
    const detect = () => {
      ...
      const surface = el?.closest(".itm-section, .itm-footer, .itm-ingress") as HTMLElement | null;
      if (!surface) return;
