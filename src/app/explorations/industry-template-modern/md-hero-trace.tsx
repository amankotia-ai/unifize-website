...
const MD_HERO_TRACE: HeroTraceData = {
  ...
  from: "Raised from SOP-118 · Class II · ISO 13485 7.5.7",
  ...
  rows: [
    ...
    { rec: "Risk file · ISO 14971", ref: "RA-067 · H-07 seal breach", fn: "Quality", done: "Re-assessed" },
  ...
  approvers: { initials: ["JS", "RK", "PR"], label: "3 approvers" },
