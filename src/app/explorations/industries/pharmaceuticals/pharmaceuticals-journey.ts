  ...
  checklistSections: [
    {
      title: "DEVIATION",
      items: [
        { label: "Description", kind: "field", value: "In-process control result outside specification" },
        { label: "Source", note: "Executed batch record · in-process controls" },
        { label: "Classification", kind: "field", value: "Major" },
      ],
    },
    {
      title: "INVESTIGATION",
      items: [
        ...
        { label: "Root cause", note: "Bound to the deviation · Quality · RA" },
      ],
    },
    {
      title: "CAPA",
      items: [
        ...
        { label: "Regulatory impact", note: "Assessed by RA" },
...
export const PHARMACEUTICALS_JOURNEY = cast(
  ...
  step(1.3, {
    ...
    focusRows: ["Corrective action · C. Dubois", "Regulatory impact assessed · N. Osei", "Effectiveness check scheduled · C. Dubois"],
