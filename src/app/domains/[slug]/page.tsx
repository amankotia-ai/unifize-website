...
import { WorkflowCanvas, WorkflowKey, ValueStreamMap, CompressionStory } from "@/components/workflow";
import { getDomain, listDomainSlugs } from "@/lib/platform-data/domains";
import { WORKFLOWS, WORKFLOW_SHOWCASE } from "@/lib/platform-data/workflows";
...
export default async function DomainPage({
  ...
  return (
    <main>
        ...
        <div className="section-inner">
          <div className="section-head stack">
            ...
            <h2 className="section-title">
              One process language, four journeys.
            </h2>
            <p className="wf-lede">
      ...
      <CompressionStory workflow={WORKFLOWS["change-control"]!} stepId="s3" />
